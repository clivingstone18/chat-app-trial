...
public class Cribbage extends CardGame {
  ...
  private ArrayList<EventLogger> eventLoggers;
...
private void notifySubscribers(String str) {
	...
	public Cribbage() {
      ...
      initScore();
      eventLoggers = new ArrayList<EventLogger>();
      addSubscriber(new DealLogger());
      addSubscriber(new PlayerLogger());
      addSubscriber(new DiscardLogger());
      addSubscriber(new StartLogger());
      addSubscriber(new ScoreLogger());
      addSubscriber(new ShowLogger());
	  ...
	  notifySubscribers("DEAL");
	  discardToCrib();

	  notifySubscribers("DISCARD");
